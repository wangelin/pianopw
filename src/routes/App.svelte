      ...
      for (let r = 0; r < rows; r++) {
        ...
        for (
          ...
          if (number_is_natural(k)) {
            ...
            draw_white_key(ctx, letter, x, y, key_width, canvas.height / rows, {
              text: show_text ? note : "",
  ...
  <div class="controls row">
    <div class="col">
      ...
      <div class="row">
        <button
          onclick={() => (
            (n_low = note_to_number("A0")), (n_high = note_to_number("C8"))
          )}>88</button
        >
        <button
          onclick={() => (
            (n_low = note_to_number("E1")), (n_high = note_to_number("G7"))
          )}>76</button
        >
        <button
          onclick={() => (
            (n_low = note_to_number("C2")), (n_high = note_to_number("C7"))
          )}>61</button
        >
        <button
          onclick={() => (
            (n_low = note_to_number("C2")), (n_high = note_to_number("C6"))
          )}>49</button
        >
        <button
          onclick={() => (
            (n_low = note_to_number("F3")), (n_high = note_to_number("F6"))
          )}>37</button
        >
        <button
          onclick={() => (
            (n_low = note_to_number("C3")), (n_high = note_to_number("C5"))
          )}>25</button
        >
      </div>
    </div>
